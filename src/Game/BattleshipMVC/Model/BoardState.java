...
public class BoardState extends Observable {
    ...
    private void createBoat(final int row, final int column, final int boatSize, final boolean isHorizontal) {
        GridBoat gridBoat = new GridBoat(row, column, boatSize, isHorizontal);
    ...
    /**
     * Returns total number of hit points player has remaining
     *
     * @return Total number of hit points player has remaining
     */
    ...
    /**
     * Returns the maximum number of hit points a player may have
     *
     * @return Maximum number of hit points a player may have
     */
    ...
    /**
     * Returns a list of all the boats on the player's board
     *
     * @return List of all the boats on the player's board
     */
    public List<GridBoat> getBoatsOnBoard() {
        return boatsOnBoard;
    }
}
